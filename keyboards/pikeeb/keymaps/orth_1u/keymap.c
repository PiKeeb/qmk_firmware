...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_BASE] = LAYOUT_orth_1u_full(
        ...
        KC_TAB,   KC_Q,     KC_W,     KC_E,     KC_R,     KC_T,     KC_LBRC,  KC_TILD,  KC_RBRC,  KC_Y,     KC_U,     KC_I,     KC_O,     KC_P,     KC_BSLS,
        ...
        KC_LCTL,  KC_LALT,  KC_LGUI,  MO(_FN1), XXXXXXX,  KC_SPC,   KC_SPC,   MO(_SET), KC_SPC,   KC_SPC,   XXXXXXX,  MO(_FN2), KC_RGUI,  KC_RALT,  KC_RCTL
    ),
    /* Modifiers */
    ...
    [_SET] = LAYOUT_orth_1u_full(
        RESET,    OUT_USB,  OUT_BT,   OUT_AUTO, _______,  _______,  _______,  _______,  BL_STEP,  BL_DEC,   BL_INC,   TS_SW,    OLED_SW,  BATMODE,  USB_SW,
        _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  PG_CYCL,
        _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  PG_STAT,
        _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,
        _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______
    )
};
